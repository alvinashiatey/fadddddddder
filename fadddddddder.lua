...
local effect_definitions = {
	...
	-- TIME-BASED: pitch shifter
	{
		id = "harmoniser",
		engine = "pitch_shift",
		label = "harmoniser",
		params = { "pitch", "detune", "blend", "tone" },
		param_count = 4,
		defaults = { amount = 0.62, param1 = 0.62, param2 = 0.18, param3 = 0.55, param4 = 0.6 },
	},
	{
		id = "octave_drop",
		engine = "pitch_shift",
		...
		params = { "pitch", "detune", "blend", "tone" },
		param_count = 4,
		defaults = { amount = 0.7, param1 = 0.0, param2 = 0.1, param3 = 0.42, param4 = 0.4 },
	},
	{
		id = "shimmer_up",
		engine = "pitch_shift",
		...
		params = { "pitch", "detune", "blend", "tone" },
		param_count = 4,
		defaults = { amount = 0.66, param1 = 1.0, param2 = 0.22, param3 = 0.6, param4 = 0.78 },
	},
	{
		id = "thick_detune",
		engine = "pitch_shift",
		...
		params = { "pitch", "detune", "blend", "tone" },
		param_count = 4,
		defaults = { amount = 0.58, param1 = 0.5, param2 = 0.74, param3 = 0.48, param4 = 0.55 },
	},

	-- TIME-BASED: reverse buffer
	{
		id = "reverse_swell",
		engine = "reverse",
		label = "reverse swell",
		params = { "length", "rate", "free", "tone" },
		param_count = 4,
		defaults = { amount = 0.78, param1 = 0.42, param2 = 0.5, param3 = 0.5, param4 = 0.6 },
	},
	{
		id = "backwards_grain",
		engine = "reverse",
		label = "backwards grain",
		params = { "length", "rate", "free", "tone" },
		param_count = 4,
		defaults = { amount = 0.86, param1 = 0.82, param2 = 0.4, param3 = 0.5, param4 = 0.5 },
	},

	-- TIME-BASED: slapback echo
	{
		id = "slapback",
		engine = "slapback",
		label = "slapback",
		params = { "time", "free", "level", "tone" },
		param_count = 4,
		defaults = { amount = 0.6, param1 = 0.38, param2 = 0.5, param3 = 0.62, param4 = 0.7 },
	},
	{
		id = "dub_slap",
		engine = "slapback",
		...
		params = { "time", "free", "level", "tone" },
		param_count = 4,
		defaults = { amount = 0.66, param1 = 0.72, param2 = 0.5, param3 = 0.8, param4 = 0.35 },
	},

	-- EXPERIMENTAL: convolution reverb
	{
		id = "conv_room",
		engine = "conv_reverb",
		label = "conv room",
		params = { "size", "density", "free", "tone" },
		param_count = 4,
		defaults = { amount = 0.58, param1 = 0.4, param2 = 0.6, param3 = 0.5, param4 = 0.62 },
	},
	{
		id = "conv_cathedral",
		engine = "conv_reverb",
		label = "conv cathedral",
		params = { "size", "density", "free", "tone" },
		param_count = 4,
		defaults = { amount = 0.72, param1 = 0.92, param2 = 0.84, param3 = 0.5, param4 = 0.48 },
	},

	-- EXPERIMENTAL: spectral smear / freeze
	{
		id = "spectral_freeze",
		engine = "spectral_freeze",
		label = "spectral freeze",
		params = { "freeze", "smear", "free", "tone" },
		param_count = 4,
		defaults = { amount = 0.82, param1 = 0.8, param2 = 0.3, param3 = 0.5, param4 = 0.58 },
	},
	{
		id = "ghost_smear",
		engine = "spectral_freeze",
		...
		params = { "freeze", "smear", "free", "tone" },
		param_count = 4,
		defaults = { amount = 0.7, param1 = 0.2, param2 = 0.74, param3 = 0.5, param4 = 0.66 },
	},

	-- EXPERIMENTAL: amplitude follower → filter (auto-wah)
	{
		id = "auto_wah",
		engine = "auto_wah",
		label = "auto wah",
		params = { "sens", "range", "res", "base" },
		param_count = 4,
		defaults = { amount = 0.7, param1 = 0.55, param2 = 0.6, param3 = 0.62, param4 = 0.32 },
	},
	{
		id = "envelope_sweep",
		engine = "auto_wah",
		...
		params = { "sens", "range", "res", "base" },
		param_count = 4,
		defaults = { amount = 0.78, param1 = 0.78, param2 = 0.82, param3 = 0.78, param4 = 0.2 },
	},
}
